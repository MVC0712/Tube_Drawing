...
try {
    ...
    b_drawing_l = '$b_drawing_l',
    b_drawing_out_d = '$b_drawing_out_d',
    b_drawing_in_d = '$b_drawing_in_d',
    b_drawing_t = '$b_drawing_t',
    a_drawing_l = '$a_drawing_l',
    a_drawing_out_d = '$a_drawing_out_d',
    a_drawing_in_d = '$a_drawing_in_d',
    a_drawing_t = '$a_drawing_t',
