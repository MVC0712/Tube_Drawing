...
try {
    ...
    al_temp_cast = '$al_temp_cast' ,
    al_temp_gate = '$al_temp_gate' ,
    aluminium_ingot = '$aluminium_ingot' ,
    aluminium_orther = '$aluminium_orther' ,
    break_time = '$break_time' ,
    casting_end = '$casting_end' ,
    ...
    flux_1 = '$flux_1' ,
    flux_2 = '$flux_2' ,
    hydro_time_1 = '$hydro_time_1' ,
    hydro_time_2 = '$hydro_time_2' ,
    hydro_time_3 = '$hydro_time_3' ,
    hydro_time_4 = '$hydro_time_4' ,
    hydro_value_1 = '$hydro_value_1' ,
    hydro_value_2 = '$hydro_value_2' ,
    hydro_value_3 = '$hydro_value_3' ,
    hydro_value_4 = '$hydro_value_4' ,
    input_cr_1 = '$input_cr_1' ,
    input_cr_2 = '$input_cr_2' ,
    input_cu_1 = '$input_cu_1' ,
    input_cu_2 = '$input_cu_2' ,
    input_fe_1 = '$input_fe_1' ,
    input_fe_2 = '$input_fe_2' ,
    input_mg_1 = '$input_mg_1' ,
    input_mg_2 = '$input_mg_2' ,
    input_mn_1 = '$input_mn_1' ,
    input_mn_2 = '$input_mn_2' ,
    input_si_1 = '$input_si_1' ,
    input_si_2 = '$input_si_2' ,
    input_ti_b_1 = '$input_ti_b_1' ,
    input_ti_b_2 = '$input_ti_b_2' ,
    input_zn_1 = '$input_zn_1' ,
    input_zn_2 = '$input_zn_2' ,
    me_cr_1 = '$me_cr_1' ,
    me_cr_2 = '$me_cr_2' ,
    me_cr_3 = '$me_cr_3' ,
    me_cu_1 = '$me_cu_1' ,
    ...
    me_zn_2 = '$me_zn_2' ,
    me_zn_3 = '$me_zn_3' ,
    melting_end = '$melting_end' ,
    melting_gas_end = '$melting_gas_end' ,
    melting_gas_start = '$melting_gas_start' ,
    melting_start = '$melting_start' ,
