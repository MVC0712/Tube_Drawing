...
FROM
    ...
    m_production_numbers ON m_dies.production_number_id = m_production_numbers.id
        LEFT JOIN
    m_production_numbers_sub ON m_production_numbers.id = m_production_numbers_sub.production_number_id
        LEFT JOIN
    t_press_plan ON t_press_directive.dies_id = t_press_plan.dies_id
